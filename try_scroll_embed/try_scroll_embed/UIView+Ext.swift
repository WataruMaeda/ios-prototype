...
//  StickyMemo
//
//  Created by Wataru Maeda on 2018/01/13.
...
extension UIView {
  ...
  func sizeWidthFit(maxHeight: CGFloat) {
    var estimateHeight = sizeThatFits(CGSize(width: frame.size.width, height: CGFloat.greatestFiniteMagnitude)).height
